...
public class WeatherConditionList {
    ...
    public WeatherConditionList() {
        ...
        mListSnowToHangeul.add(new WeatherCondition("511","얼어붙는 비"));
        ...
        mListSnowToHangeul.add(new WeatherCondition("600","가벼운 눈"));
        mListSnowToHangeul.add(new WeatherCondition("601","눈"));
        mListSnowToHangeul.add(new WeatherCondition("602","폭설"));
        mListSnowToHangeul.add(new WeatherCondition("611","진눈 깨비"));
        mListSnowToHangeul.add(new WeatherCondition("612","급성 진눈 깨비"));
        ...
        mListMistToHangeul.add(new WeatherCondition("721","안개"));
        mListMistToHangeul.add(new WeatherCondition("731","황사 바람"));
        mListMistToHangeul.add(new WeatherCondition("741","강한 안개"));
...
//        //-----------------Additional----------//
        ...
        mListWindToHangeul.add(new WeatherCondition("952","약한 바람"));
        mListWindToHangeul.add(new WeatherCondition("953","약한 바람"));
        mListWindToHangeul.add(new WeatherCondition("954","산들 바람"));
        mListWindToHangeul.add(new WeatherCondition("955","산들 바람"));
        mListWindToHangeul.add(new WeatherCondition("956","강풍"));
        mListWindToHangeul.add(new WeatherCondition("957","강풍"));
